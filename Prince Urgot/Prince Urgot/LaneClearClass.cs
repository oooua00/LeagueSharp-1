...
namespace Prince_Urgot
{
    internal class LaneClearClass
    {
        ...
        {
            LaneClearMenu.AddSubMenu(new Menu("LaneClear", "laneclear"));
            LaneClearMenu.SubMenu("laneclear").AddItem(new MenuItem("useQ", "Use Q").SetValue(true));
            LaneClearMenu.SubMenu("laneclear").AddItem(new MenuItem("useE", "Use E").SetValue(true));
            LaneClearMenu.SubMenu("laneclear").AddItem(new MenuItem("LaneClearManaPercent", "Minimum Mana Percent").SetValue(new Slider(30, 0, 100)));
        }
