...
namespace Talon
{
    internal class DamageIndicator
    {
        ...
        {
            get { return Config.TalonConfig.Item("apollo.viktor.draw.ind.bool").GetValue<bool>(); }
        }

        public static Color FillColor
        {
            get { return Config.TalonConfig.Item("apollo.viktor.draw.ind.fill").GetValue<Circle>().Color; }
        }

        public static bool Fill
        {
            get { return Config.TalonConfig.Item("apollo.viktor.draw.ind.fill").GetValue<Circle>().Active; }
        }
